...
class PgnToFen:
    ...
    def getFullFen(self):
        return self.getFen() + ' ' + ('w ' if self.whiteToMove else 'b ') + self.enpassant + ' ' + (
    ...
    def validRookMoves(self, posistions, move, specificCol, specificRow):
        ...
        if len(potensialPosisitionsToRemove) == 1:
            ...
            try:
                ...
                correctPos = None  # or some other default value
        if (correctPos == 0):
...
if __name__ == "__main__":
    pgnFormat = 'c4 Nc6 Nc3 e5 Nf3 Nf6 g3 d5 cxd5 Nxd5 Bg2 Nb6 O-O Be7 a3 Be6 b4 a5 b5 Nd4 Nxd4 exd4 Na4 Bd5 Nxb6 ' \
                'cxb6 Bxd5 '
    converter = PgnToFen()
